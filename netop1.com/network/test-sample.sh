#!/bin/bash
# Run this sript in cli container to create test channel and test a sample chaincode
# usage: test-sample.sh

cd /opt/gopath/src/github.com/hyperledger/fabric/peer/config/artifacts
